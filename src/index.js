  ...
  handleClick(id) {
    switch (id) {
      ...
      case "break-decrement":
        if (this.state.isToggleOn == true) { } else if (this.state.breaks == 1) { } else {
          this.setState({
      ...
      case "break-increment":
        if (this.state.isToggleOn == true) { } else if (this.state.breaks == 60) { } else {
          this.setState({
            breaks: this.state.breaks + 1,
            seconds: 0,
            session: this.state.session,
      ...
      case "session-decrement":
        if (this.state.isToggleOn == true) { } else if (this.state.session == 1) { } else {
          this.setState({
      ...
      case "session-increment":
        if (this.state.isToggleOn == true) { } else if (this.state.session == 60) { } else {
          this.setState({
            session: this.state.session + 1,
            minutes: this.state.session + 1,
            seconds: 0
...
<div id="clock">
    ...
    <div id="adjust-containers">
      <div id="break-label">
        <h3>Break Length</h3>
        <div id="break-container">
          <svg id="break-decrement" onClick={() => this.handleClick("break-decrement")} width="1.2em" height="1.2em"viewBox="0 0 16 16" class="bi bi-chevron-down" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
